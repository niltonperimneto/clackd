...
└── hal/
    ...
    └── legacy/
        ...
        ├── logitech.rs     # Logitech binary blob compiler
        └── razer.rs        # Razer binary blob compiler
```
...
| 4 — Legacy Polyfill | 🔲 Planned | Shadow-state machine, Logitech + Razer blob compilers |
